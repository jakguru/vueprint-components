/**
 * @module @jakguru/vueprint-components/constants/countries
 */

/**
 * Describes the shape of a country item.
 * @typedef {Object} CountryItem
 * @property {string} alpha2 - The alpha2 code of the country.
...
export const countries: CountryItem[] = [
  ...
  { name: "Antigua & Barbuda", alpha2: "AG" },
  ...
  { name: "Cape Verde Islands", alpha2: "CV" },
  ...
  { name: "Congo (Brazzaville)", alpha2: "CG" },
  { name: "Congo (Kinshasa)", alpha2: "CD" },
  ...
  { name: "Saint Christopher & Nevis", alpha2: "KN" },
  { name: "Saint Helena", alpha2: "SH" },
  { name: "Saint Lucia", alpha2: "LC" },
  { name: "Saint Martin", alpha2: "MF" },
  { name: "Saint Pierre & Miquelon", alpha2: "PM" },
  { name: "Saint Vincent & The Grenadines", alpha2: "VC" },
  { name: "Samoa", alpha2: "WS" },
  { name: "San Marino", alpha2: "SM" },
  { name: "Sao Tome & Principe", alpha2: "ST" },
  ...
  { name: "Somaliland", alpha2: "SO" },
  { name: "South Africa", alpha2: "ZA" },
  { name: "South Georgia & The South Sandwish Islands", alpha2: "GS" },
